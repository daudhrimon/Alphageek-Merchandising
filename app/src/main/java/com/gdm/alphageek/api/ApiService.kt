package com.gdm.alphageek.api

import com.gdm.alphageek.data.local.down_sync.DownSyncResponse
import com.gdm.alphageek.data.remote.BaseResponse
import com.gdm.alphageek.data.remote.bank.BankResponse
import com.gdm.alphageek.data.remote.country.CountryResponse
import com.gdm.alphageek.data.remote.document_type.DocumentTypeResponse
import com.gdm.alphageek.data.remote.education.EducationResponse
import com.gdm.alphageek.data.remote.lga.LgaResponse
import com.gdm.alphageek.data.remote.login.LoginResponse
import com.gdm.alphageek.data.remote.profile.ProfileResponse
import com.gdm.alphageek.data.remote.state.StateResponse
...
interface ApiService {
    ...
    suspend fun liveTrac(
        @Field("gio_lat") email: String,
        @Field("gio_long") password: String,
        @Field("address") deviceId: String,
